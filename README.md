...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=81)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对“大学生艺术节”方面的信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款“大学生艺术节”管理系统这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短“大学生艺术节”方面的信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约“大学生艺术节”方面的信息管理需要的人力和资金。所以“大学生艺术节”管理系统是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对“大学生艺术节”方面的信息管理，采用“大学生艺术节”管理系统可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用“大学生艺术节”管理系统，其意义如下：

第一点：“大学生艺术节”管理系统的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对“大学生艺术节”管理系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对“大学生艺术节”管理系统进行介绍时，将按照如下内容进行。

第一部分：介绍“大学生艺术节”管理系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发“大学生艺术节”管理系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对“大学生艺术节”管理系统的功能要求，以及对“大学生艺术节”管理系统的性能要求等；
...
# 第2章 开发环境与技术
“大学生艺术节”管理系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对“大学生艺术节”管理系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，“大学生艺术节”管理系统开发可行。
### 3.1.3 操作可行性
“大学生艺术节”管理系统根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作“大学生艺术节”管理系统。
...
“大学生艺术节”管理系统经过分析，确定了其需要设置管理员的角色，其操作的功能通过用例图展示（见下图）。管理员管理表演项目，比赛项目，比赛结果以及节前信息，管理表演项目以及比赛项目报名信息。

![](/md/blog.005.png)

图3.5 管理员用例图

“大学生艺术节”管理系统经过分析，确定了其需要设置用户的角色，其操作的功能通过用例图展示（见下图）。用户参与表演项目与比赛项目的报名，对表演项目与比赛项目进行收藏和留言。
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|biaoyanxiangmu\_name|varchar(255)|是|NULL|表演项目  |
|biaoyanxiangmu\_types|int(200)|是|NULL|表演类型  |
|biaoyanxiangmu\_number|int(200)|是|NULL|报名人数|
|biaoyanxiangmu\_time|timestamp|是|NULL|结束报名时间|
|biaoyanxiangmu\_photo|varchar(255)|是|NULL|预览图|
|biaoyanxiangmu\_content|text|是|NULL|表演规则|
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|biaoyanxiangmu\_id|int(11)|是|NULL|表演项目id|
...
|biaoyanxiangmu\_id|int(11)|是|NULL|表演项目id|
|yonghu\_id|int(11)|是|NULL|用户id|
|biaoyanxiangmu\_liuyan\_content|text|是|NULL|留言内容|
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|biaoyanxiangmu\_id|int(200)|是|NULL|报名项目|
|yonghu\_id|int(200)|是|NULL|报名人|
|insert\_time|timestamp|是|NULL|报名时间|
|create\_time|timestamp|是|NULL|创建时间|
表4.5 比赛结果信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|bishaixiangm\_id|int(200)|是|NULL|比赛项目|
|bishaijieguo\_time|timestamp|是|NULL|比赛结束时间|
|biaoyanxiangmu\_bisaijieguo|varchar(11)|是|NULL|比赛结果|
|create\_time|timestamp|是|NULL|创建时间|
表4.6 比赛项目信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|bishaixiangm\_name|varchar(255)|是|NULL|比赛项目  |
|bishaixiangm\_types|int(200)|是|NULL|比赛类型  |
|bishaixiangm\_number|int(200)|是|NULL|报名人数|
|bishaixiangm\_time|timestamp|是|NULL|结束报名时间|
|bishaixiangm\_photo|varchar(255)|是|NULL|预览图|
|bishaixiangm\_content|text|是|NULL|比赛规则|
|insert\_time|timestamp|是|NULL|发布时间|
|create\_time|timestamp|是|NULL|创建时间 |
表4.7 比赛项目收藏信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|bishaixiangm\_id|int(11)|是|NULL|比赛项目id|
|yonghu\_id|int(11)|是|NULL|用户id|
|insert\_time|timestamp|是|NULL|收藏时间|
|create\_time|timestamp|是|NULL|创建时间 |
表4.8 比赛项目留言信息表
...
|bishaixiangm\_id|int(11)|是|NULL|比赛项目id|
|yonghu\_id|int(11)|是|NULL|用户id|
|bishaixiangm\_liuyan\_content|text|是|NULL|留言内容|
|reply\_content|text|是|NULL|回复内容|
|insert\_time|timestamp|是|NULL|讨论时间|
|create\_time|timestamp|是|NULL|创建时间|
表4.9 比赛项目报名信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|bishaixiangm\_id|int(200)|是|NULL|报名项目|
|yonghu\_id|int(200)|是|NULL|报名人|
|insert\_time|timestamp|是|NULL|报名时间|
|create\_time|timestamp|是|NULL|创建时间|
表4.10 节前信息表
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|jieqianxinxi\_name|varchar(255)|是|NULL|标题  |
|jieqianxinxi\_photo|varchar(255)|是|NULL|图片|
|insert\_time|timestamp|是|NULL|发布时间|
|jieqianxinxi\_content|text|是|NULL|详情内容|
|create\_time|timestamp|是|NULL|创建时间 |
表4.11 公告信息表
...
图5.3 节前信息管理页面
### 5.1.4 比赛项目报名管理
管理员进入指定功能操作区之后可以管理比赛项目报名信息。其页面见下图。管理员查看用户参与报名的比赛项目信息。

![](/md/blog.017.png)

图5.4 比赛项目报名管理页面
### 5.1.5 表演项目报名管理
管理员进入指定功能操作区之后可以管理表演项目报名信息。其页面见下图。管理员查看用户参与报名的表演项目信息。
...
## 5.2 用户功能实现
### 5.2.1 表演项目
用户进入指定功能操作区之后可以查看表演项目信息。其页面见下图。用户在当前页面可以收藏表演项目，对表演项目进行报名或留言。

![](/md/blog.019.png)

图5.6 表演项目页面
### 5.2.2 比赛项目
用户进入指定功能操作区之后可以查看比赛项目。其页面见下图。用户在当前页面可以收藏比赛项目，对比赛项目进行报名或留言。

![](/md/blog.020.png)

图5.7 比赛项目页面
### 5.2.3 节前信息
用户进入指定功能操作区之后可以查看节前信息。其页面见下图。用户点击节前信息的图片可以查看其对应的介绍信息。

![](/md/blog.021.png)

图5.8 节前信息页面
### 5.2.4 公告信息
用户进入指定功能操作区之后可以查看公告信息。其页面见下图。用户查询公告，可以查看各个公告标题对应的内容。
